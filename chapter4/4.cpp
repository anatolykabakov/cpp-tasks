/*
Task 4: Write the program with function for calculate the binominal coefficients.
Parameters of binominal coefficients are passed to function as arguments.
*/
