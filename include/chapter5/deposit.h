/**
 * @brief Chapter 5, task 5.
 * @details Write the program with class for describe a situation,
...
class Deposit {
 public:
  Deposit(char* name, double deposit, double rate, unsigned int time)
  ...
  double get_deposit() const { return deposit_; }
